...
export default function HomeAboutCard() {
  ...
  const warmAbout = () => router.prefetch("/about");
  ...
  return <aside className={styles.card} aria-label="关于147数据局">
    ...
    <Link className={styles.action} href="/about" onPointerEnter={warmAbout} onFocus={warmAbout} onTouchStart={warmAbout} onClick={rememberHomepageReturn}>了解147数据局 <span aria-hidden="true">→</span></Link>
  </aside>;
}
